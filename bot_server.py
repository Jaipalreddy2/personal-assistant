...
def handle_command(text):
    ...
    if cmd == "/help":
        return ("🤖 *Bunty — Available Commands:*\n\n"
                "*LinkedIn Jobs:*\n"
                "/findjobs — search LinkedIn Easy Apply jobs, send for approval\n"
                "/applyjobs — apply to all approved LinkedIn jobs\n"
                "/autoapply — find + apply LinkedIn jobs instantly (no approval)\n"
